  ...
  return (
    <div className="mr-[16.5rem]">
      <div className="container mx-auto">
        ...
        <p className="mb-4">
          At <span className="font-semibold">Strike</span>, we are committed to protecting your privacy.
        ...
        <p className="mb-4">
          ...
          as your name, email address, and payment information. We may also
          collect information about your use of our website through cookies and
        ...
        <p className="mb-4">
          We use your personal information to process transactions, provide
          customer support, and improve our website. We may also use your
          information to send you promotional materials, but you can opt out of
        ...
        <p className="mb-4">
          ...
          us in operating our website and conducting our business, but only to
          the extent necessary to perform their services.
        </p>
        ...
        <p className="mb-4">
          ...
          about your privacy, please contact us at [contact email].
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-2">
