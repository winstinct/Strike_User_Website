    ...
    <>
      <Dialog open={size === "sm"} size={size || "sm"} handler={handleOpen}>
        ...
        <DialogBody>
          <ShareSocial
            url={`${code}`}
            socialTypes={["whatsapp", "facebook", "linkedin"]}
          />
        </DialogBody>
    ...
    <main>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-8 text-[1.5rem] mt-[0.8rem]">
          <ShareSocialModal code={refferal?.refferalCode} icon={whatsApp} />
          <ShareSocialModal code={refferal?.refferalCode} icon={facebook} />
          <ShareSocialModal code={refferal?.refferalCode} icon={linkedIn} />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
