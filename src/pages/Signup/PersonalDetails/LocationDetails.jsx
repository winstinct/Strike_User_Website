  ...
  return (
    <div>
      ...
      <div className="w-full">
          <p className="font-medium">Country<RequiredStar/></p>
          <Select className="border-[1px] border-gray-300 rounded-md" placeholder="gg">
      ...
      <div className="w-full">
          <p className="font-medium">State<RequiredStar/></p>
          <Select className="border-[1px] border-gray-300 rounded-md" placeholder="gg">
            <Option value="Male">Male</Option>
            <Option value="Female">Female</Option>
            <Option value="Other">Other</Option>
      ...
      <div className="w-full">
          <p className="font-medium">City<RequiredStar/></p>
          <Select className="border-[1px] border-gray-300 rounded-md" placeholder="gg">
            <Option value="Male">Male</Option>
            <Option value="Female">Female</Option>
            <Option value="Other">Other</Option>
        ...
        <div className="md:col-span-2">
          ...
          <textarea className="outline-none border-[1px] border-gray-300 px-3 py-1 rounded-lg w-full" name="address" id="address"></textarea>
        </div>
      </div>
