      ...
      <div className="flex flex-col justify-center md:mt-0 mt-[2rem]">
        <form action="">
          ...
          <div className="my-[1.5rem] space-y-[1rem]">
            ...
            <div>
            <label className="font-medium block mb-[0.2rem]" htmlFor="password">Referral Code</label>
            <input className="border-[1px] border-[#CCC] px-[1rem] py-[0.4rem] rounded-[6px] outline-none w-full" type="text" placeholder="Enter your code here" id="password" />
            </div>
          </div>
